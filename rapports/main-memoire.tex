...
\usepackage[ruled,vlined]{algorithm2e}
 ...
 \bibliographystyle{apalike}
  ...
  \titre{Détection d'anomalies basée sur les représentation latentes d'un autoencodeur variationnel}
  ...
  \codirection{François-Michel De Rainville, codirecteur de recherche}
...
\include{experiments}             % experimentations
