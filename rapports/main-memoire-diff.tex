...
\include{remerciements_diff}         % remerciements
...
\include{introduction_diff}          % introduction
\include{background_diff}             % background
\include{methodologie_diff}             % methodologie
\include{experiments_diff}             % experimentations
\include{conclusion_diff}            % conclusion
